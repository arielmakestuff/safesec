          ...
          S::Item: 'static
{
    ...
    fn control_channel(&mut self) -> (mpsc::Sender<ServerTypeMessage<S::Item>>,
                                      &mut mpsc::Receiver<ServerTypeMessage<S::Item>>);
    fn handler_channel(&mut self) -> (mpsc::UnboundedSender<S::Item>,
          ...
          S::Item: 'static
{
    ...
    handler: (mpsc::UnboundedSender<S::Item>,
              mpsc::UnboundedReceiver<S::Item>),
    listener: S,
    loop_handle: Handle,
}
          ...
          S::Item: 'static
{
    ...
    pub fn new(loop_handle: Handle, stream: S, channel_size: usize) -> Self {
        let control = mpsc::channel::<ServerTypeMessage<S::Item>>(channel_size);
